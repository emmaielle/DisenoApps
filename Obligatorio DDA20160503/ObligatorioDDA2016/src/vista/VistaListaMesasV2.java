 ...
 * @author Euge
 */
public class VistaListaMesasV2 extends javax.swing.JDialog implements VistaListaMesas {

    /**
     * Creates new form VistaListaMesasV2
     */
    private ControladorListaMesas2 controlador;
    public VistaListaMesasV2(java.awt.Frame parent, boolean modal, Jugador j) {
        super(parent, modal);
        initComponents();
    ...
    public void abrirMesa(Mesa m, Jugador j) {
        dispose();
        new VistaMesaV1(j, m).setVisible(true);
    }
